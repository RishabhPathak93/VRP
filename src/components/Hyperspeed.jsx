...
Hyperspeed.propTypes = {
  effectOptions: PropTypes.shape({
    ...
    distortion: PropTypes.string,
    length: PropTypes.number,
    roadWidth: PropTypes.number,
    islandWidth: PropTypes.number,
    lanesPerRoad: PropTypes.number,
    fov: PropTypes.number,
    fovSpeedUp: PropTypes.number,
    speedUp: PropTypes.number,
    carLightsFade: PropTypes.number,
    totalSideLightSticks: PropTypes.number,
    lightPairsPerRoadWay: PropTypes.number,
    shoulderLinesWidthPercentage: PropTypes.number,
    brokenLinesWidthPercentage: PropTypes.number,
    brokenLinesLengthPercentage: PropTypes.number,
    lightStickWidth: PropTypes.arrayOf(PropTypes.number),
    lightStickHeight: PropTypes.arrayOf(PropTypes.number),
    movingAwaySpeed: PropTypes.arrayOf(PropTypes.number),
    movingCloserSpeed: PropTypes.arrayOf(PropTypes.number),
    carLightsLength: PropTypes.arrayOf(PropTypes.number),
    carLightsRadius: PropTypes.arrayOf(PropTypes.number),
    carWidthPercentage: PropTypes.arrayOf(PropTypes.number),
    carShiftX: PropTypes.arrayOf(PropTypes.number),
    carFloorSeparation: PropTypes.arrayOf(PropTypes.number),
    colors: PropTypes.shape({
      roadColor: PropTypes.number,
      islandColor: PropTypes.number,
      background: PropTypes.number,
      shoulderLines: PropTypes.number,
      brokenLines: PropTypes.number,
      leftCars: PropTypes.arrayOf(PropTypes.number),
      rightCars: PropTypes.arrayOf(PropTypes.number),
      sticks: PropTypes.number,
    }),
  }),
};
